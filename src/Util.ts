 ...
 */
export function newExpandItemRequest(data: ExpandItemRequestData): ExpandItemRequest {
...
export function newGatewayRequest(
  ...
  if (numPopulated != 1) {
    throw new Error("invalid data for gateway request, must have exactly 1 field populated")
  }
