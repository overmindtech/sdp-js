...
const $queryService = createQueryService({  service: ApiKeyService,});
 ...
 * @generated from rpc apikeys.ApiKeyService.GetAPIKey
 */
export const getAPIKey: UnaryFunctionsWithHooks<GetAPIKeyRequest, GetAPIKeyResponse> = {   ...$queryService.getAPIKey,  ...createUnaryHooks($queryService.getAPIKey)};

/**
 * @generated from rpc apikeys.ApiKeyService.UpdateAPIKey
 */
export const updateAPIKey: UnaryFunctionsWithHooks<UpdateAPIKeyRequest, UpdateAPIKeyResponse> = {   ...$queryService.updateAPIKey,  ...createUnaryHooks($queryService.updateAPIKey)};

/**
 * @generated from rpc apikeys.ApiKeyService.ListAPIKeys
 */
export const listAPIKeys: UnaryFunctionsWithHooks<ListAPIKeysRequest, ListAPIKeysResponse> = {   ...$queryService.listAPIKeys,  ...createUnaryHooks($queryService.listAPIKeys)};
 ...
 * @generated from rpc apikeys.ApiKeyService.ExchangeKeyForToken
 */
export const exchangeKeyForToken: UnaryFunctionsWithHooks<ExchangeKeyForTokenRequest, ExchangeKeyForTokenResponse> = {   ...$queryService.exchangeKeyForToken,  ...createUnaryHooks($queryService.exchangeKeyForToken)};
