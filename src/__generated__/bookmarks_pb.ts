 ...
 *
 * @generated from message Bookmark
 */
export class Bookmark extends Message<Bookmark> {
  /**
   * @generated from field: BookmarkMetadata metadata = 1;
   */
  metadata?: BookmarkMetadata;

  /**
   * @generated from field: BookmarkProperties properties = 2;
   */
  ...
  static readonly typeName = "Bookmark";
 ...
 *
 * @generated from message BookmarkProperties
 */
export class BookmarkProperties extends Message<BookmarkProperties> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "BookmarkProperties";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message BookmarkMetadata
 */
export class BookmarkMetadata extends Message<BookmarkMetadata> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "BookmarkMetadata";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ListBookmarkResponse extends Message<ListBookmarkResponse> {
  /**
   * @generated from field: repeated Bookmark bookmarks = 3;
   */
  bookmarks: Bookmark[] = [];
 ...
 *
 * @generated from message CreateBookmarkRequest
 */
export class CreateBookmarkRequest extends Message<CreateBookmarkRequest> {
  /**
   * @generated from field: BookmarkProperties properties = 1;
   */
  properties?: BookmarkProperties;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "CreateBookmarkRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message CreateBookmarkResponse
 */
export class CreateBookmarkResponse extends Message<CreateBookmarkResponse> {
  /**
   * @generated from field: Bookmark bookmark = 1;
   */
  bookmark?: Bookmark;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "CreateBookmarkResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message GetBookmarkRequest
 */
export class GetBookmarkRequest extends Message<GetBookmarkRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "GetBookmarkRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "UUID", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
...
/**
 * @generated from message GetBookmarkResponse
 */
export class GetBookmarkResponse extends Message<GetBookmarkResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "GetBookmarkResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "bookmark", kind: "message", T: Bookmark },
  ]);
