...
import { DeleteSnapshotRequest, ListSnapshotsRequest, LoadSnapshotRequest, SnapshotDeleteResult, SnapshotListResult, SnapshotLoadResult, SnapshotStoreResult, StoreSnapshotRequest } from "./snapshots_pb.ts";
import { LoadBookmarkRequest, LoadBookmarkResponse, StoreBookmarkRequest, StoreBookmarkResponse } from "./bookmarks_pb.ts";
...
export class GatewayRequest extends Message<GatewayRequest> {
  ...
  requestType: {
     ...
     *
     * @generated from field: ListSnapshotsRequest listSnapshots = 9;
     */
     ...
     *
     * @generated from field: StoreSnapshotRequest storeSnapshot = 10;
     */
    value: StoreSnapshotRequest;
    case: "storeSnapshot";
  } | {
    /**
     * load a snapshot into the current state
     *
     * @generated from field: LoadSnapshotRequest loadSnapshot = 11;
     */
    value: LoadSnapshotRequest;
    case: "loadSnapshot";
  } | {
    /**
     ...
     *
     * @generated from field: DeleteSnapshotRequest deleteSnapshot = 12;
     */
     ...
     *
     * @generated from field: StoreBookmarkRequest storeBookmark = 14;
     */
    value: StoreBookmarkRequest;
    case: "storeBookmark";
  } | {
    /**
     ...
     * DeleteBookmarkRequest deleteBookmark = 16;
     * TODO: implement?
     ...
     *
     * @generated from field: LoadBookmarkRequest loadBookmark = 15;
     */
    value: LoadBookmarkRequest;
    case: "loadBookmark";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 9, name: "listSnapshots", kind: "message", T: ListSnapshotsRequest, oneof: "request_type" },
    { no: 10, name: "storeSnapshot", kind: "message", T: StoreSnapshotRequest, oneof: "request_type" },
    { no: 11, name: "loadSnapshot", kind: "message", T: LoadSnapshotRequest, oneof: "request_type" },
    { no: 12, name: "deleteSnapshot", kind: "message", T: DeleteSnapshotRequest, oneof: "request_type" },
    { no: 14, name: "storeBookmark", kind: "message", T: StoreBookmarkRequest, oneof: "request_type" },
    { no: 15, name: "loadBookmark", kind: "message", T: LoadBookmarkRequest, oneof: "request_type" },
...
export class GatewayResponse extends Message<GatewayResponse> {
  ...
  responseType: {
     ...
     *
     * @generated from field: StoreBookmarkResponse bookmarkStored = 15;
     */
    value: StoreBookmarkResponse;
    case: "bookmarkStored";
  } | {
    /**
     * BookmarkDeleteResult bookmarkDeleteResult = 17;
     *
     * @generated from field: LoadBookmarkResponse bookmarkLoaded = 16;
     */
    value: LoadBookmarkResponse;
    case: "bookmarkLoaded";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 15, name: "bookmarkStored", kind: "message", T: StoreBookmarkResponse, oneof: "response_type" },
    { no: 16, name: "bookmarkLoaded", kind: "message", T: LoadBookmarkResponse, oneof: "response_type" },
  ]);
